...
void LPUART1_IRQHandler(void) {
    ...
    if (LPUART1->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART1_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART1->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    if (LPUART1->STAT & LPUART_STAT_RDRF_MASK) {
        ...
        xQueueSendFromISR(LPUART1_RX_QUEUE, &c, NULL);
    }
...
void LPUART2_IRQHandler(void) {
    ...
    if (LPUART2->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART2_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART2->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    if (LPUART2->STAT & LPUART_STAT_RDRF_MASK) {
        ...
        xQueueSendFromISR(LPUART2_RX_QUEUE, &c, NULL);
    }
...
void LPUART3_IRQHandler(void) {
    ...
    if (LPUART3->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART3_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART3->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    // RX interrupt
    if (LPUART3->STAT & LPUART_STAT_RDRF_MASK) {
        char c = (char)(LPUART3->DATA & 0xFF);
        xQueueSendFromISR(LPUART3_RX_QUEUE, &c, NULL);
    }
...
void LPUART4_IRQHandler(void) {
    ...
    if (LPUART4->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART4_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART4->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    if (LPUART4->STAT & LPUART_STAT_RDRF_MASK) {
        ...
        xQueueSendFromISR(LPUART4_RX_QUEUE, &c, NULL);
    }
...
void LPUART5_IRQHandler(void) {
    ...
    if (LPUART5->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART5_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART5->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    // RX interrupt
    if (LPUART5->STAT & LPUART_STAT_RDRF_MASK) {
        char c = (char)(LPUART5->DATA & 0xFF);
        xQueueSendFromISR(LPUART5_RX_QUEUE, &c, NULL);
    }
...
void LPUART6_IRQHandler(void) {
    ...
    if (LPUART6->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART6_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART6->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    // RX interrupt
    if (LPUART6->STAT & LPUART_STAT_RDRF_MASK) {
        char c = (char)(LPUART6->DATA & 0xFF);
        xQueueSendFromISR(LPUART6_RX_QUEUE, &c, NULL);
    }
...
void LPUART7_IRQHandler(void) {
    ...
    if (LPUART7->STAT & LPUART_STAT_TDRE_MASK) {
        char c;
        if (xQueueReceiveFromISR(LPUART7_TX_QUEUE, &c, NULL) == pdPASS) {
            LPUART7->DATA = c; // TX register’a yaz
        } else {
            // TX queue boş → TIE disable
    ...
    // RX interrupt
    if (LPUART7->STAT & LPUART_STAT_RDRF_MASK) {
        char c = (char)(LPUART7->DATA & 0xFF);
        xQueueSendFromISR(LPUART7_RX_QUEUE, &c, NULL);
    }
